...
function SideNotes() {
  ...
  const calendarHeight = document.querySelector('#calendar-height');
  ...
  return (
    <>
      <div style={{position: 'relative', textAlign: 'right'}}>
        <div onMouseDown={handleResizeDrag} className={'border-capture top'} style={{pointerEvents: 'auto', cursor: 'row-resize'}}/>
